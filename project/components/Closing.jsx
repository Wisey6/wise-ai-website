      ...
      <div className="contact__lhs">
        ...
        <div className="contact__meta">
          <div>
            ...
            <span>10 Fournier St<br/>London E1 6QE</span>
          </div>
          <div>
            <span className="contact__meta-k">General</span>
            <span>hello@wiseai.co<br/>+44 20 7946 0112</span>
          </div>
          <div>
            <span className="contact__meta-k">Hours</span>
            <span>Mon–Thu · 09:00–18:00<br/>Fri · by appointment</span>
          </div>
        </div>
      </div>
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__cols">
        ...
        <div>
          <span className="footer__k">Studio</span>
          <span>10 Fournier St, London E1 6QE</span>
          <span>hello@wiseai.co</span>
          <span>+44 20 7946 0112</span>
        </div>
        <div>
          <span className="footer__k">Now</span>
          <span>LDN · {time}</span>
          <span>Accepting Q3 engagements</span>
          <span>Next cohort: 02 Jun</span>
        </div>
      </div>
